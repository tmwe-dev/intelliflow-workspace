...
import { Database, Users, Mail, Search, Mic, Brain, Shield, Zap, FileText, Layers } from "lucide-react";
...
const toolMap: Record<string, ToolActivation[]> = {
  churn: [
...
const ToolActivationBar = ({ scenarioKey, visible }: ToolActivationBarProps) => {
  const tools = scenarioKey ? toolMap[scenarioKey] || toolMap.churn : [];
          ...
          <div className="flex items-center gap-1 py-2 px-1">
            ...
            {tools.map((tool, i) => (
              <motion.div
                ...
                style={{
                  background: `hsl(${tool.color} / 0.04)`,
                  border: `1px solid hsl(${tool.color} / 0.06)`,
                }}
              >
